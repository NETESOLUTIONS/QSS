...
\supportinginfo{http://dx.doi.org/10.7910/DVN/PQ6ILM}
...
Optimal indolence: a normative microscopic approach to work and
leisure. Network Neuroscience 1(1):
1−12.}

\received{20 October 2013}
\accepted{7 November 2013}
\published{26 January 2014}
\handlingeditor{Editor Name}
...
%% NO Appendices in the Network Neuroscience style
...
\section{Jargon Samples in margin}
...
For example, some citations from the CompPsychSample bibliography:
