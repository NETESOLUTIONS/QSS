...
Uzzi's algorithm seeks to systematically shuffles every reference in the network but replacements are selected from the set \{x,a,b,c,d,e...\} rather than the multi-set \{x,x,x,x,x,b,c,c,c,d,d,e...\} of eligible references. 
