...
In fact, what began as a simple experiment turned out to be quite complicated and, in our assessment, out of scope for this article  We have modified the Discussion to make this point. In addition, we emphasize that innovation and conventionality are measured by legacy conventions that assist disciplined thought but should not be considered ground truth.
