...
While our work has shown that the use of local networks defines a benchmark more consistent with research citation patterns, further work might explore how the alignment of benchmarks with practice might be further improved.  These can be viewed, and possibly implemented as further constraints on the random assignment of citations to publications. For example, one might take into consideration the proximity of possible citations as defined in a co-author network~\citep{wallace_lariviere_gingras_2012} when defining probabilities for citation substitutions. Other foundations for benchmarks might include consideration of the possibility that citation patterns are partly due to communications within and between fields, as well a reflection of and exertion of intellectual influence~\citep{stigler_1994}.
