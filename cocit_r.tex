...
We constructed three disciplinary datasets based on keyword searches: immunology,   metabolism, and   applied physics. 
For the first two, rooted in biomedical research, we searched Pubmed for the term `immunology' or `metabolism' in the years 1985, 1995, and 2005~(Table \ref{tab:disc-datasets}). Pubmed IDs (pmids) returned were matched to WoS IDs (wos\_ids) and used to retrieve relevant articles. For the applied physics dataset, we directly searched traditional subject labels in WoS for `applied physics'. 
\textcolor{blue}{
While immunology and applied physics represent somewhat small subnetworks (each occupying about 4\% of WoS), metabolism represents approximately 22\% of WoS, making them interesting and meaningful test cases. }
...
To study the disciplinary composition of references in our custom datasets, we used the the WoS extended classification consisting of 153 subjects aggregated into the five major research areas of life sciences and biomedicine, physical sciences, social sciences, technology, and arts and humanities. 
%We measured the frequency with which these five major research areas occur in WoS for the years 1985, 1995, and 2005 and observed the following proportions (some publications qualify for more than one label): (i) life sciences and biomedicine (52.9\%), physical sciences (33.4\%), social sciences (7.2\%), technology (17.9\%), and arts and humanities (1\%). We then matched our applied physics dataset to physical science, and our immunology and metabolism datasets to the life science and biomedicine research areas respectively. We analyzed the composition of the references in our three datasets and observed that 84.2\% of the references in the applied physics dataset belonged to physical sciences, and 93.7\% and 92.1\% of the references in the immunology and metabolism datasets respectively belonged to the life sciences and biomedicine research area. 
The two largest of these research areas are physical sciences and life sciences and biomedicine,  which contribute on average approximately 35.1\% and 62.8\%, respectively, of the references in WoS over the three years of interest.
%While there is some variability in different years, %approximately 35.1\% of the references in WoS are from the physical sciences and approximately 62.8\% of the references are from the life sciences and biomedicine.
While there is some variability over the years, according to the Uzzi  {\em et al.} model, we would expect close to 35.1\% of the references cited by the publications in any large network  to be drawn from the physical sciences and roughly 62.8\% of the references to be drawn from the life sciences and biomedicine.
Yet the empirical data present a very different  story: 79.6\% of the references cited in physical sciences publications are from the physical sciences and 89.9\% of the references cited in life sciences and biomedicine publications are from the life sciences and biomedicine.
In other words, the empirical data shows a strong tendency of publications to cite papers that are in the same major research area rather than in some other research area.  Thus, there is a strong bias towards citations that are {\em inside-the-network} rather than {\em outside-the-network}.
This is inconsistent with the Uzzi {\em et al.} model, but makes sense, given what is well established about citation practice.
%These data suggest at a high level (i) that applying a discipline-indifferent model in Monte Carlo simulations would result in misspecification (ii) strongly that references are likely to belong to the same research area as the publications that cite them rather than being drawn evenly from all five research areas. 
For example, our observations are in agreement with \cite{wallace_lariviere_gingras_2012} who found that, often, a majority of an article's citations are from the specialty of the article, even though that percentage varied among disciplines in the eight specialties they investigated (from approximately 39\% to 89\% for 2006). 
Furthermore, these findings strongly argue that Uzzi {\em et al.}'s model has substantial model misspecification (in deviating substantially from the empirical data), and supports our concern that
definitions of  innovation and conventionality that are based on deviation from expected values under Uzzi's model may not be merited.
...
%(Should we insert a table with all statistical results?)
...
%We conclude that Uzzi et al.'s finding of high hit rates in the HNHC category does not hold generally for disciplinary-based datasets and that 
%novel citation patterns are 
