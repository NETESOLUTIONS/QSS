...
\textcolor{blue}{
Our approach is different} in the following ways: (i) we sampled citations proportional to their citation frequency (equivalently from a multiset rather than a set) in order to better reflect citation practice, 
...
\begin{table}[ht]
\caption{Model misspecification is reduced by constraining substitutions to the local  disciplinary subnetworks. 
We computed 
...
%by  restricting the reference substitutions to the disciplinary subnetwork  as compared to treating all substitutions within WoS as equiprobable.
}
\label{tab:kld}
\centering
\begin{tabular}{| ccccc |} 
...
\textcolor{blue}{We found} 
that z-scores changed sign more as a consequences  of choice of background network (local network or all of WoS) and much less as a consequence of choice of sampling algorithm
