...
Furthermore, the categories displaying the greatest hit rate vary to some extent with the year. For example, when the 1\% top-cited articles are deemed to be hits, the category with the highest hit rate in applied physics for 1985 and 1995 is HNLC, although the hit rate for HNHC is slightly greater than for HNLC in 2005 (1.3\% versus 1.1\%).
