...
\subsection{Model Misspecification and the Attributes of Disciplinary Context} A source of misspecification in the Uzzi {\em et al.}~model arises from not accounting for disciplinary heterogeneity by treating all references as equiprobable substituents. Under this model, the probability of replacing a reference in one discipline by another reference in a second discipline is identical to the proportion of the articles in WoS that from the second discipline. If the model approximated citation practice, the proportion of references within papers published in a given discipline $D$ would be expected to be equal to the proportion of articles in the discipline $D$, and--conversely--the degree to which the proportion deviates from the expected value would reflect the extent of model misspecification. 
...
To study the disciplinary composition of references in our custom datasets, we used the the WoS extended classification consisting of 153 subjects aggregated into the five major research areas of life sciences and biomedicine, physical sciences, social sciences, technology, and arts and humanities. We measured the frequency with which these five major research areas occur in WoS for the years 1985, 1995, and 2005 and observed the following proportions (some publications qualify for more than one label): (i) life sciences and biomedicine (52.9\%), physical sciences (33.4\%), social sciences (7.2\%), technology (17.9\%), and arts and humanities (1\%). We then matched our applied physics dataset to physical science, and our immunology and metabolism datasets to the life science and biomedicine research areas respectively. We analyzed the composition of the references in our three datasets and observed that 84.2\% of the references in the applied physics dataset belonged to physical sciences, and 93.7\% and 92.1\% of the references in the immunology and metabolism datasets respectively belonged to the life sciences and biomedicine research area. These data suggest at a high level (i) that applying a discipline-indifferent model in Monte Carlo simulations would result in misspecification (ii) strongly that references are likely to belong to the same research area as the publications that cite them rather than being drawn evenly from all five research areas. Our observations are in agreement with \cite{wallace_lariviere_gingras_2012} who found that, often, a majority of an article's citations are from the specialty of the article, although that percentage varied among disciplines in the eight specialties they investigated: from approximately 39\% to 89\% for 2006. 
