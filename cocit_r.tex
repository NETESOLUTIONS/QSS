...
Another possible symptom of model misspecification is to find that the citations associated with an article under random sampling do not match with the observed disciplinary makeup of citation in practice. \emph{More needed here}  Here is Sitaram's study:   

Adding to the point of papers citing papers belonging to the same discipline, I collected the subject areas for all the cited references from the 1985 Applied Physics dataset and searched for the keyword `Physics`. Then calculated the percentage of references related to Applied Physics for each paper References-related-to-physics/Total-references. Only papers with at-least 5 references were considered and the total publications were 6991.
Results show a mean of 0.77 i.e. on an average papers cite 77\% of their references belonging to same discipline.

\noindent count    6991.000000\\
mean        0.774002
