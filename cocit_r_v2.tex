...
\textcolor{green}{A related study by \cite{wang_bias_2017} also uses journal pairings to study novelty in scientific publications but focuses on previously undetected journal pairs to generate a novelty index}
